	...
	public void datosDelPagoIBPay(BeanSheetExcel bean) 
	{
		try
		{
			...
			if (responseKibana != null) 
			{
				...
				{
					VentanaPrincipalYerros.showInfo("TimeOut_NDC_DIST_9009.datosDelPagoIBPay(): Array de resultados vac�o en scriptIberiaPay.sh");
				}
	        }
		}
		catch (Exception e) {
	...
	public void analizar(BeanSheetExcel bean) 
	{
		try
		{
			...
			if (responseKibana != null) 
			{
				...
				{
					System.out.println("TimeOut_NDC_DIST_9009.analizar(): Array de resultados vac�o en scriptPaymentInfo.sh");
				}
	        }
		}
		catch (Exception e) {
