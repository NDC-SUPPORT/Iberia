...
public class InternalError_PMT_PPM_8030 {
	...
	public void analizar(BeanSheetExcel bean) 
	{
		...
		{	
			...
			e.printStackTrace();
			VentanaPrincipalIberiaPay.showError("InternalError_PMT_PPM_8030.analizar() -> " + "fecha: " + this.bean.getFechaLocal() + " - request: " + this.bean.getCodRequest());
