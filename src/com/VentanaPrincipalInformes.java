...
public class VentanaPrincipalInformes implements ActionListener {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VentanaPrincipalInformes window = new VentanaPrincipalInformes();
	 ...
	 */
	public VentanaPrincipalInformes() {
		initialize();
	}
	...
	public void actionPerformed(ActionEvent e) 
	{
		...
		BeanFormularioInformes bF_Informes = null;
		...
		if (e.getSource().equals(btnEjecutar)) 
		{
			...
			bF_Informes = new BeanFormularioInformes(fchParaScript, fchParaScript, txfIdExcel.getText());
			
			ProcesoInformes p = new ProcesoInformes();
			p.ejecutar(bF_Informes);
		}
